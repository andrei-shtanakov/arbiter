...
| Catalog conformance (Rust) | `cargo test -p arbiter-core --test catalog_conformance` | `arbiter-core/tests/catalog_conformance.rs` over `tests/fixtures/catalog-conformance/v1/` | 7 tests / 13 expectations |
