...
def generate_expert_examples(
    ...
    # Rule 1: complex/critical + Rust -> claude_code@claude-sonnet-4-6
    ...
    # Rule 2: complex/critical + Python -> claude_code@claude-sonnet-4-6
    for complexity in [COMP_COMPLEX, COMP_CRITICAL]:
    ...
    # Rule 6: TypeScript + feature -> codex_cli@gpt-5.5
    for complexity in [
        COMP_TRIVIAL,
        COMP_SIMPLE,
        COMP_MODERATE,
    ...
    # Rule 7: Go language -> codex_cli@gpt-5.5
    ...
    # Rule 8: moderate + Python -> codex_cli@gpt-5.5
    for task in [TASK_FEATURE, TASK_BUGFIX, TASK_REFACTOR]:
        for priority in [PRI_LOW, PRI_NORMAL, PRI_HIGH]:
    ...
    # Rule 10: DEFAULT -> claude_code@claude-sonnet-4-6 (catch-all)
    for task in [
        TASK_FEATURE,
        TASK_BUGFIX,
        TASK_REFACTOR,
